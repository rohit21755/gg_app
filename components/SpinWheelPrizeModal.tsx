...
export default function SpinWheelPrizeModal({
  ...
  const prizeLabel = prize.label || prize.name || prize.title || prize.prize_name || 'Congratulations!';
  const prizeValue = 
    prize.value || 
    prize.points || 
    prize.xp || 
    ...
    prize.reward_points || 
    prize.amount ||
    (prize.reward && (prize.reward.points || prize.reward.xp || prize.reward.value)) ||
    0;
